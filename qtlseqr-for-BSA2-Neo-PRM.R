...
library("stringi")
library("ggplot2")
setwd("D:/Genome-seq/IId-cross-BSA-24-10-01/vcf-hap/BSA2-Neo-PRM/")
...
vcf <- read.vcfR("./BSA2-Neo-PRM_hap_Marker_1065.vcf")
...
set_path <- paste("D:/Genome-seq/IId-cross-BSA-24-10-01/vcf-hap/BSA2-Neo-PRM/",dirNames[,1],sep="")
