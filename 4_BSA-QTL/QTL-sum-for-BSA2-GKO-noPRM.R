...
setwd("D:/Genome-seq/IId-cross-BSA-24-10-01/vcf-hap/BSA2-GKO-noPRM/")
getwd()
vcf <- read.vcfR("./BSA2-GKO-noPRM_hap_Marker_1065.vcf")
...
df <- df_ggplot[df_ggplot$group %in% c("W389_W392","W389_W401","W389_W416","W389_W423","W389_W429","W389_W436","W389_W484","W389_W488","W389_W491","W389_W498"),]
df3 <- df_ggplot[df_ggplot$group %in% c("W389_W401","W389_W423","W389_W436"),]
...
p0 <- ggplot(df,aes(x=POS,y=Gprime,color=group)) +
  ...
  scale_color_manual(values =c3,, name = "Days post infection",
                     breaks = c("W389_W392","W389_W401","W389_W416","W389_W423","W389_W429","W389_W436","W389_W484","W389_W488","W389_W491","W389_W498"), 
                     labels = c("DPI 6 (W392)", "DPI 12 (W401)", "DPI 18 (W416)","DPI 24 (W423)", "DPI 30 (W429)", "DPI 36 (W436)", "DPI 42 (W484)", "DPI 48 (W488)","DPI 54 (W491)", "DPI 60 (W498)"))+
  stat_smooth(method = "loess", se= F, span = 0.1, size = 0.5, n=1000, level = 0.95) +
...
ggsave("BSA2-GKO-noPRM-G.pdf",p0,width = 9,height = 3,dpi = 300 )
ggsave("BSA2-GKO-noPRM-G.png",p0,width = 9,height = 3,dpi = 600 )
...
ggsave("BSA2-GKO-noPRM-G-dot.pdf",p1,width = 9,height = 3,dpi = 300 )
ggsave("BSA2-GKO-noPRM-G-dot.png",p1,width = 9,height = 3,dpi = 600 )

p00 <- ggplot(df3,aes(x=POS,y=Gprime,color=group)) +
  theme(plot.title = element_text(size = 20, face = "bold",hjust = 0.5,color = "black"))+
  scale_color_manual(values =c4, name = "Days post infection",
                     breaks = c("W389_W401","W389_W423","W389_W436"), 
                     labels = c("DPI 12 (W401)","DPI 24 (W423)","DPI 36 (W436)"))+
  stat_smooth(method = "loess", se= F, span = 0.1, size = 0.5, n=1000, level = 0.95) +
  geom_hline(aes(yintercept=91),linewidth=0.5,linetype=5,col="red")+
  facet_wrap(~ CHROM, ncol = 8, strip.position="bottom",,scales = "free_x")+
  scale_x_continuous(expand = c(0.01,0.01)) +
...
ggsave("BSA2-GKO-noPRM-G-3samples.pdf",p00,width = 9,height = 3,dpi = 300 )
ggsave("BSA2-GKO-noPRM-G-3samples.png",p00,width = 9,height = 3,dpi = 600 )
